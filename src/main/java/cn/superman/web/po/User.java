...
public class User implements Serializable {
    ...
    public String toString() {
        return "User{" +
                ...
                ", nickname='" + nickname + '\'' +
                ", email='" + email + '\'' +
                ", sourceFileRootPath='" + sourceFileRootPath + '\'' +
                ", rightProblemCount=" + rightProblemCount +
                ", haveDoneProblem=" + haveDoneProblem +
                ", submitRecordTableName='" + submitRecordTableName + '\'' +
                ", isBan=" + isBan +
                ", totalSolveValue=" + totalSolveValue +
